      ...
      <div class="media">
  		...
  		<div class="media-body">
            ...
            <li>
          	...
          	<button type="button" onclick="location.href='./StoreUpdate.st?s_no=${sdto.s_no}';" style="background:white"><i class="glyphicon glyphicon-pencil"></i></button>
          	<button type="button" onclick="con(${sdto.s_no})" style="background:white" ><i class="glyphicon glyphicon-trash"></i></button></span>
          	</li>
			</ul>
    		<hr>
