					...
					<c:set var="img" value="${e.n_img.split(',')[1] }"/>
                     <div class="row">
                         <div class="light-slide-item">            
                             <div class="clearfix">
                             <!-- 이벤트 이미지 -->
                             <c:if test="${n_no == e.n_no && e.c_code!=null }"> <!-- 일치하는 항목에 대해서 수행  -->
                               <a href="./getCouponAction.co?c_code=${e.c_code}" > <img src="assets/img/event/${img}" style="width: 100%">	</a>
                             <!-- 이벤트 이미지 -->
                             </c:if>
                               <c:if test="${n_no == e.n_no && e.c_code==null}" >
